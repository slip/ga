	...
	<div class="page-content">
		...
		<div class="row">
			<div class="banner col-two-third">
				<a class="graphic" href="http://greggallman.shop.redstarmerch.com/"><img src="<?php echo get_template_directory_uri(); ?>/img/store-banner.jpg" alt="Enter The Online Store" /></a>
				<a class="button" href="http://greggallman.shop.redstarmerch.com/">Enter The Online Store</a>
			</div>
