			...
			<div class="row">
				<div class="col-three">
					<div class="legal">
						...
						<p><?php if(is_front_page()):{ ?><a href="http://resolution.agency/" target="_blank">Designed by Resolution</a><?php } else:{ ?><a href="http://resolution.agency/" target="_blank" rel="nofollow">Designed by Resolution</a><?php } endif; ?></p>
					</div>
				</div>
				<div class="col-three">
