...
<aside id="secondary" class="widget-area" role="complementary">
	...
	<?php if( have_rows('sidebar_promos', 'option') ): ?>
      ...
      $new_window = get_sub_field('new_window','option');
			?>

			<div class="promo">
				<a href="<?php echo $link; ?>" <?php if ($new_window) {
				  echo "target='_blank'";
				} ?>><img src="<?php echo $graphic['sizes']['sidebar-promo']; ?>" alt="<?php echo $graphic['alt'] ?>" /></a>
			</div>
