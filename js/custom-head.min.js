!function(window, document, undefined) {
    ...
    isSVG || !function(window, document) {
        ...
        html5.type += " print", html5.shivPrint = shivPrint, shivPrint(document), "object" == typeof module && module.exports && (module.exports = html5);
    ...
    Modernizr.addTest("flexbox", testAllProps("flexBasis", "1px", !0)), Modernizr.addTest("inlinesvg", function() {
        var div = createElement("div");
        return div.innerHTML = "<svg/>", "http://www.w3.org/2000/svg" == ("undefined" != typeof SVGRect && div.firstChild && div.firstChild.namespaceURI);
    }), Modernizr.addTest("mediaqueries", mq("only all")), testRunner(), setClasses(classes), 
